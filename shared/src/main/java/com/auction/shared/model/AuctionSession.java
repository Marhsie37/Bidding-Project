...
public class AuctionSession implements Serializable {
  ...
  public ConcurrentHashMap<String, Double> getAutoBids() {
    return autoBids;
  }

  public void setAutoBids(ConcurrentHashMap<String, Double> autoBids) {
    this.autoBids = autoBids;
  }

  public void addAutoBid(String username, double maxBid) {
    if (username != null) {
      autoBids.put(username, maxBid);
    }
  }

  public void removeAutoBid(String username) {
    if (username != null) {
