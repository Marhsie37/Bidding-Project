...
public class User implements Serializable {
    ...
    // Từ khóa transient giúp mật khẩu không bị đóng gói gửi qua mạng
    ...
    // Sử dụng equalsIgnoreCase để tránh lỗi phân biệt hoa/thường
    ...
    // Phương thức hỗ trợ in log kiểm tra
    @Override
